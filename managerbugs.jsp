...
<%
               try{
                ...
                int mid= rs1.getInt(1);
                 ...
                 String que="select  BID,CID,PID as ProductName,SEVERITY,PRIORITY,SUMMARY,DETAILS,OS_USING,SOFTWARE_LIST,FILENAME1 as FileName,date_format(POST_DATE,'dd-mm-yyyy') as POSTEDDATE,ASSIGNED  from bug_details where pid in (select pid from products  where mid="+mid+" ) and assigned='N' order by bid";
...
%>                              <td  align="center"   height=20 bgcolor=<%=bcolor%>     style="font-weight:bold;font-size:7pt;font-family:verdana;color:#000080">
                                        ...
                                        bid=rs.getString(i);
                                           ...
                                           %>
                                <input    type="submit" name="submit" value= <%= bid %>  style={cursor:hand} style="font-weight:bold;font-size:7pt;font-family:verdana;color:red;border-top-style:none;border-bottom-style:none;border-left-style:none;border-right-style:none;background-color='yellow';width=20px"   >
                                      <%                  continue;
                                                        }
                                      %>
